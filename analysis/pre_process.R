...
data_set <- read.csv('answercodes_complete_cleaned.csv')
...
# my_comparisons = c('adaptability','adaptivty')
# ggboxplot(na.omit(NEO.df), x = "Conditions", y = "Score",
          # color = "black", palette = "npg",fill="Conditions" ,facet.by = "Item")
